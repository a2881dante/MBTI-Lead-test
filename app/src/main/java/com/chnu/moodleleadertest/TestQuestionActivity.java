...
import com.chnu.moodleleadertest.test.MBTItest;
import com.chnu.moodleleadertest.widget.VerticalSeekBar;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(pos < max-1) {
                    ...
                    Intent intent = new Intent(TestQuestionActivity.this, ResultActivity.class);
