...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLead = (Button)findViewById(R.id.result_lead);
        ...
        btnPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ResultActivity.this, PersonTypeActivity.class);
                intent.putExtra(DescriptorActivity.ID, ResultObject.result.page);
        ...
        btnLead.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ResultActivity.this, ResultLeadActivity.class);
                startActivity(intent);
            }
        });
